...
const deleteStudent = (roll) => {
  ...
  if (conf) {
    const students = getData("students");
    const update_students = students.filter((data, index) => data.roll !== roll);
...
<div >
  ...
  <tfoot>
    <tr>
      <td colspan="4">
        <button class="btn btn-primary px-5"><i class="fas fa-print"></i> Print</button>
        <button class="btn btn-danger px-5" data-bs-dismiss="modal">Close</button>
      </td>
    </tr>
  </tfoot>
</div>
